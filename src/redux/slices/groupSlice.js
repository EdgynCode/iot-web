...
import {
  ...
  addLearnersToGroup,
  getAllGroups, // Import action mới
  createGroup, // Import action createGroup để xử lý
  removeGroup, // Import action removeGroup để xử lý
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(getAllGroups.fulfilled, (state, action) => {
        state.loading = false;
        state.data = action.payload; // Cập nhật state với tất cả các nhóm
      })
